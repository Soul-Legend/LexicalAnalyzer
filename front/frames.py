...
def create_start_screen_frame(app_instance):
    ...
    ctk.CTkLabel(title_text_frame, text="Analisador Léxico & Sintático", font=app_instance.font_title, anchor="w").pack(fill="x")
    ctk.CTkLabel(title_text_frame, text="Trabalhos de Linguagens Formais e Compiladores", font=app_instance.font_subtitle, anchor="w", text_color=("gray30", "gray70")).pack(fill="x")
...
def create_syntactic_test_mode_frame_widgets(app_instance):
    ...
    ctk.CTkLabel(left_panel, text="Teste Completo (Sintático)", font=("Arial", 16, "bold")).pack(pady=10, padx=10)

    ctk.CTkLabel(left_panel, text="Gramática do Teste:").pack(pady=(10,2), padx=10, anchor="w")
    grammar_display = ctk.CTkTextbox(left_panel, height=150, font=("Consolas", 10), state="disabled")
    grammar_display.pack(pady=2, padx=10, fill="x")
    widgets["grammar_display"] = grammar_display

    ctk.CTkLabel(left_panel, text="Sequência de Tokens do Teste:").pack(pady=(10,2), padx=10, anchor="w")
    token_stream_display = ctk.CTkTextbox(left_panel, height=100, font=("Consolas", 10), state="disabled")
